        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (btnSua.Text == "Lưu")
                {
                    ...
                    SqlConnection cnn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\nhanvien.mdf;Integrated Security=True;Connect Timeout=30");
                    cnn.Open();
                    sua = "update Nhanvien set [Giới tính] =N'" + nv.Gioitinh + "',[Địa chỉ] ='" + txtDiachi.Text + "',[SĐT] ='" + txtSĐT.Text + "',[Ngày sinh]='" + dtNgaysinh.Text + "',[Giờ làm]='" + txtGiolam.Text + "',[Hệ lương]='" + txtHeluong.Text + "', [Lương] = '" + txtLuong.Text + "' where ([Họ tên] = N'" + txtHoTen.Text + "' )";
